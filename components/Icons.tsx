...
export const ReplaceIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const ShuffleIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0011.664 0l3.18-3.185m-3.181-3.182L12 12m0 0l-3.182-3.182m0 0a8.25 8.25 0 00-11.664 0L3 12m9-9l3.182 3.182m0 0a8.25 8.25 0 000 11.664l-3.182 3.182" />
    </svg>
);
...
export const PinIcon: React.FC<{ className?: string; isPinned?: boolean }> = ({ className = "w-5 h-5", isPinned = false }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill={isPinned ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth={1.5} className={className}>
        <path d="M10 3.75a2 2 0 0 0-4 0v5.5a2 2 0 0 0 4 0v-5.5Z" />
        <path d="M10 3.75a2 2 0 0 1 4 0v5.5a2 2 0 0 1-4 0v-5.5Z" />
        <path d="M4 9.5a2.5 2.5 0 0 0-2.5 2.5v1.25a.75.75 0 0 0 .75.75h14.5a.75.75 0 0 0 .75-.75v-1.25a2.5 2.5 0 0 0-2.5-2.5h-1.25" />
        <path d="M10 14v5" />
        <path d="M8.75 19h2.5" />
    </svg>
);

export const RequeueIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0011.664 0l3.18-3.185m-3.181 0l-3.182-3.182m0 0a8.25 8.25 0 00-11.664 0l-3.18 3.185" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M3 10.5v-4.5a1.5 1.5 0 011.5-1.5h15a1.5 1.5 0 011.5 1.5v12a1.5 1.5 0 01-1.5 1.5h-4.5" />
  </svg>
);
